...
import { printHelloWorld } from "../../dist_npm_package/dist_index.js"; // import {printHelloWorld} from '../dist_npm_package/dist_index.js'
...
describe('TestTitle', function () {
  ...
  it('async action here', async function () {//this.timeout(500);
  });
});
